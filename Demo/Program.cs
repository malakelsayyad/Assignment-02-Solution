namespace Demo
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //Control statement
            //1.Conditional control statement (if statement,switch staement)
            ...
            #region conditional
            //1.conditional control statement (if ,switch )
            #region EX01
            ...
            //Immutable datatype : can't change it's value after creation 
            ...
            //Console.WriteLine($"Name1Hashcode : {Name1 .GetHashCode()}"); //id : indicates address
